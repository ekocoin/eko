...
uint256 hashGenesisBlock("0x343f343cf88491a6cc0ab7efc8ce9c2435edc17aabd3681a2d9460b62789eb3e");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1464503105, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040e1bc81f265228a92a336dc9c908c31c59d0b31a8809353b2b941754f23e9efeb312c9656e0b1b2a3b2dd89636c9b01b7ad1c0aa032f353fec189b3a3cf9e019") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1464503105;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1721476;
        ...
        assert(block.hashMerkleRoot == uint256("0xa53bf0277ad7569b3faea6f7608a2bea12ee8dd79d2f2949bb5e1f0382fc398b"));
...
unsigned char pchMessageStart[4] = { 0x8d, 0xb9, 0x92, 0x39 }; // EkoCoin: increase each by adding 2 to bitcoin's value.
